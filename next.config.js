...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=(), payment=(), usb=()' },
  {
    ...
    value: [
      ...
      "form-action 'self'",
      "script-src 'self' 'unsafe-inline' https://js.hs-scripts.com https://js.hs-analytics.net https://js.usemessages.com",
      "style-src 'self' 'unsafe-inline'",
      "img-src 'self' data: blob: https:",
      "font-src 'self' data: https:",
      "connect-src 'self' https://*.googleapis.com https://*.hubspot.com https://*.hsforms.com https://*.hubapi.com https://api.opencagedata.com",
