...
async function getTermsContent(): Promise<DocumentData | null> {
    const docRef = doc(db, "pages", "terms-of-service");
        ...
        <div className="container max-w-4xl mx-auto">
            ...
            <Card className="p-6 md:p-8">
                <CardHeader>
                    ...
                    <CardDescription>Last updated: {content.lastUpdated}</CardDescription>
                </CardHeader>
                <CardContent>
