    ...
    return (
        <div className="space-y-8">
            <div className="flex items-start gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Gérer l'équipe</h1>
                    <p className="text-muted-foreground mt-1">Invitez et gérez les utilisateurs avec des privilèges administratifs.</p>
                </div>
            </div>
