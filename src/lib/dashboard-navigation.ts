...
export const dashboardRouteRegistry: readonly DashboardRouteDefinition[] = [
  ...
  {
    id: "admin-job-sources",
    path: "/dashboard/admin/job-sources",
    roles: CONTENT_ROLES,
    icon: Radar,
    label: { key: "dashboard.nav.job_sources", fr: "Sources emploi", en: "Job sources" },
    navigation: { group: "content", order: 45 },
  },
  ...
  {
    id: "admin-skills-reviews",
    path: "/dashboard/admin/skills-reviews",
    roles: ADMIN_ROLES,
    icon: Shield,
    label: { key: "dashboard.nav.skills_reviews", fr: "Revue des compétences", en: "Skills reviews" },
    navigation: { group: "administration", order: 15 },
  },
  {
    id: "admin-organization-verifications",
    path: "/dashboard/admin/organization-verifications",
    roles: ADMIN_ROLES,
    icon: BadgeCheck,
    label: { key: "dashboard.nav.organization_verifications", fr: "Vérification des organisations", en: "Organization verification" },
    navigation: { group: "administration", order: 17 },
  },
  ...
  { id: "graduate-companies", path: "/dashboard/companies", roles: ["graduate"] },
  {
    ...
    roles: ["graduate"],
    icon: Calendar,
    label: { key: "dashboard.nav.events", fr: "Événements carrière", en: "Career events" },
    navigation: { group: "career", order: 50 },
  },
  {
    id: "graduate-skills-checks",
    path: "/dashboard/skills-checks",
    roles: ["graduate"],
    icon: BadgeCheck,
    label: { key: "dashboard.nav.skills_checks", fr: "Compétences vérifiées", en: "Verified skills" },
    navigation: { group: "career", order: 60 },
  },
  { id: "graduate-skills-check-intro", path: "/dashboard/skills-checks/[checkId]", roles: ["graduate"] },
  { id: "graduate-skills-check-attempt", path: "/dashboard/skills-checks/attempt/[attemptId]", roles: ["graduate"] },
  {
    id: "graduate-assessments",
    path: "/dashboard/assessments",
    roles: ["graduate"],
    icon: Award,
    label: { key: "dashboard.nav.assessments", fr: "Exercices libres", en: "Practice exercises" },
  ...
  { id: "graduate-assessment-result", path: "/dashboard/assessment/[testId]/result", roles: ["graduate"] },
  {
    ...
    navigation: { group: "career", order: 80 },
  },
