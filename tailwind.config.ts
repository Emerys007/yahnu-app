...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        body: ['var(--font-body)', 'Afacad Flux', 'sans-serif'],
      ...
      animation: {
        'route-dash': 'route-dash 2.6s linear infinite',
        'soft-rise': 'soft-rise 0.48s cubic-bezier(0.22, 1, 0.36, 1) both',
        'accordion-down': 'accordion-down 0.2s ease-out',
        'accordion-up': 'accordion-up 0.2s ease-out',
      },
      boxShadow: {
        soft: '0 18px 50px -28px rgba(16, 61, 50, 0.28)',
        lift: '0 24px 70px -34px rgba(16, 61, 50, 0.42)',
      },
    },
  },
